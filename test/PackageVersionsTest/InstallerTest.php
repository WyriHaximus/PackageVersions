...
final class ComposerVersions
{
    ...
    public static function getVersion(string $packageName) : string
    {
        list($version) = explode('@', Versions::getVersion($packageName));
        return $version;
    }
}
...
PHP;
        ...
        self::assertSame($expectedSourceComposer, file_get_contents($expectedPath . '/ComposerVersions.php'));
