...
PHP;
    ...
    private static $generatedClassTemplateComposer = <<<'PHP'
<?php
...
PHP;
    ...
    public static function dumpVersionsClass(Event $composerEvent)
    {
        ...
        $io->write('<info>ocramius/package-versions:</info>  Generating version classes...');
        ...
        self::writeComposerVersionClassToFile(
            $composer->getConfig(),
            $composer->getPackage()
        );
        ...
        $io->write('<info>ocramius/package-versions:</info> ...done generating version classes');
    }
     ...
     * @throws \RuntimeException
     */
    private static function writeComposerVersionClassToFile(
        Config $composerConfig,
        RootPackageInterface $rootPackage
    ) {
        file_put_contents(
            self::locateRootPackageInstallPath($composerConfig, $rootPackage)
            . '/src/PackageVersions/ComposerVersions.php',
            self::$generatedClassTemplateComposer,
            0664
        );
    }
